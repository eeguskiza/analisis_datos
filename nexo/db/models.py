"""Modelos ORM del schema ``nexo`` en Postgres.
...
- ``nexo.departments``         catálogo de departamentos (rrhh/comercial/…)
- ``nexo.user_departments``    N:M users↔departments
- ``nexo.permissions``         catálogo seed del PERMISSION_MAP (fuente de verdad: dict en código)
...
# ── nexo.permissions (catálogo seed; fuente de verdad = PERMISSION_MAP en código) ──
