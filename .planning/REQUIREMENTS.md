...
- [x] **QUERY-02**: Tabla `nexo.query_thresholds` con `(endpoint, warn_ms, block_ms, updated_at, updated_by)` editable desde UI — Plan 04-01 + Plan 04-04 ✓ 2026-04-20 (schema + seeds en 04-01; UI /ajustes/limites con PUT + Recalcular factor + LISTEN/NOTIFY propagation en 04-04)
...
- [x] **QUERY-07**: `/ajustes/limites` edita umbrales; preflight aplicado en `pipeline/run`, `bbdd/query`, `capacidad` (rango > 90 días), `operarios` (rango > 90 días) — Plan 04-02 + Plan 04-04 ✓ 2026-04-20 (preflight aplicado a los 4 endpoints en 04-02; UI /ajustes/limites + /ajustes/rendimiento + recalibrate manual + cron factor_auto_refresh + query_log_cleanup completados en 04-04)
...
| QUERY-02 | Phase 4 / Plan 04-01 + 04-04 | Complete (2026-04-20) |
